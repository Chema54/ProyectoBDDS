...
public class BitacoraBajaDAO extends CompleteDAOShape<BitacoraBajaDTO, Integer> {
    ...
    @Override
    public BitacoraBajaDTO getDTOInstanceFromResultSet(ResultSet resultSet) throws SQLException {
    ...
    public void createOne(BitacoraBajaDTO bitacoraBajaDTO) throws UserDisplayableException {
        ...
        try (
            ...
            throw ExceptionHandler.handleSQLException(
                    LOGGER,
                    e,
                    "No ha sido posible crear la bitácora de baja."
            );
        }
    }
    ...
    public List<BitacoraBajaDTO> getAll() throws UserDisplayableException {
        ...
        try (
            ...
            throw ExceptionHandler.handleSQLException(
                    LOGGER,
                    e,
                    "No ha sido posible cargar las bitácoras de baja."
            );
        }
    }
    ...
    public BitacoraBajaDTO getOne(Integer id) throws UserDisplayableException {
        ...
        try (
            ...
            BitacoraBajaDTO bitacoraBajaDTO = null;

            try (ResultSet resultSet = statement.executeQuery()) {

                if (resultSet.next()) {
                    bitacoraBajaDTO = getDTOInstanceFromResultSet(resultSet);
                }
            }

            return bitacoraBajaDTO;
            ...
            throw ExceptionHandler.handleSQLException(
                    LOGGER,
                    e,
                    "No ha sido posible obtener la bitácora de baja."
            );
        }
    }
    ...
    public void updateOne(BitacoraBajaDTO bitacoraBajaDTO) throws UserDisplayableException {
        ...
        try (
            ...
            throw ExceptionHandler.handleSQLException(
                    LOGGER,
                    e,
                    "No ha sido posible actualizar la bitácora de baja."
            );
        }
    }
    ...
    public void deleteOne(Integer id) throws UserDisplayableException {
        ...
        try (
            ...
            throw ExceptionHandler.handleSQLException(
                    LOGGER,
                    e,
                    "No ha sido posible eliminar la bitácora de baja."
            );
        }
    }
}
