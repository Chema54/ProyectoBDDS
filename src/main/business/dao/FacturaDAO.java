...
public class FacturaDAO extends CompleteDAOShape<FacturaDTO, Integer> {
    ...
    public void createOne(FacturaDTO facturaDTO) throws UserDisplayableException {
        ...
        try (
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "No ha sido posible crear la factura.");
        }
    }
    ...
    public List<FacturaDTO> getAll() throws UserDisplayableException {
        ...
        try (
            ...
            while (resultSet.next()) {
                FacturaDTO facturaDTO = new FacturaDTO.FacturaBuilder()
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "No ha sido posible cargar las facturas.");
        }
    }
    ...
    public FacturaDTO getOne(Integer id) throws UserDisplayableException {
        ...
        try (
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "No ha sido posible obtener la factura.");
        }
    }
    ...
    public void updateOne(FacturaDTO facturaDTO) throws UserDisplayableException {
        try (
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "No ha sido posible actualizar la factura.");
        }
    }
    ...
    public void deleteOne(Integer id) throws UserDisplayableException {
        try (
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "No ha sido posible eliminar la factura.");
        }
    }
}