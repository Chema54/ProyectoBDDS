...
public class FXMLAprobarSalidasController implements Initializable {
    ...
    @FXML
    private TableView<CarritoSolicitudDTO> tablaAprobar;
    @FXML
    private TableColumn<CarritoSolicitudDTO, Integer> colId;
    @FXML
    private TableColumn<CarritoSolicitudDTO, String> colEmpleado;
    @FXML
    private TableColumn<CarritoSolicitudDTO, String> colArticulo;
    @FXML
    private TableColumn<CarritoSolicitudDTO, Integer> colCantidadPedida;
    @FXML
    private TableColumn<CarritoSolicitudDTO, Integer> colStock; // NUEVA COLUMNA DE STOCK
    @FXML
    private TableColumn<CarritoSolicitudDTO, String> colUso;

    @FXML
    private TextField txtCantidadReal;
